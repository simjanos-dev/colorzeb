...
mix.js('resources/js/app.js', 'public/js')
    ...
    .sass('resources/sass/countent_outside_vue_app.scss', 'public/css')
    ...
    .sass('resources/sass/custom_order.scss', 'public/css')
    ...
    .sass('resources/sass/admin_sidebar.scss', 'public/css')
