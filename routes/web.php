...
Route::get('/custom-order', 'HomeController@customOrder')->name('custom-order');
Route::post('/send-custom-order-message', 'HomeController@sendCustomOrderMessage')->name('send-custom-order-message');
